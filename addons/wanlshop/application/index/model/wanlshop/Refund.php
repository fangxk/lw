...
class Refund extends Model
{
    ...
    {
        return ['0' => __('State 0'), '1' => __('State 1'), '6' => __('State 6'), '2' => __('State 2'), '3' => __('State 3'), '4' => __('State 4'), '5' => __('State 5')];
    }
    ...
    {
        return $this->belongsTo('app\index\model\wanlshop\Order', 'order_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }
    ...
    public function pay()
    {
        return $this->belongsTo('app\index\model\wanlshop\Pay', 'order_pay_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }
}
